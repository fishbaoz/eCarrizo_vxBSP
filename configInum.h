/* configInum.h - Intel board Interrupt Number configuration header */
...
01a,15apr09,scm  written based off of pcPentium4 01e.
*/

/*
This module contains the configuration parameters for the generic
Intel board.
*/
...
#define INT_NUM_ATA1            (INT_NUM_IOAPIC_IRQF)
...
#else   /* (INCLUDE_VIRTUAL_WIRE_MODE) || (PIC_MODE) */
